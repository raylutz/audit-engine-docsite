...
### Adjudicated / Modified Record {#adjudicated-modified-record}
...
This is the process of human review of ballots or ballot images and providing an interpretation of the vote on that ballot. _[Dominion](#dominion-voting-systems-dominion)_ has an adjudication module that facilitates adjudication by election staff. AuditEngine also has an_ [Adjudicator App](#adjudicator-app)_ that can help fine tune the results obtained by AuditEngine.


### Adjudicator App {#adjudicator-app}

This component of AuditEngine is a browser-based application that provides a user interface to check any ballot, particularly flagged contests or comparison results that are disagreed. It presents the evaluation by AuditEngine and the evaluation by the voting system (per the [CVR](#cast-vote-record-cvr)) and that portion of the ballot showing the users marks or _[BMD](#ballot-marking-device-bmd)_ _[ballot summary card](#ballot-summary-card)_. The Adjudicator App can also be used without any voting system results to fine-tune the results by AuditEngine by reviewing any records that have been [flagged](#flagged) for further review.
...
### Archive / Zip Archive {#archive-zip-archive}
...
### AuditEngine App {#auditengine-app}
...
### Ballot Anonymity {#ballot-anonymity}
...
### Ballot Image Audit (BIA) {#ballot-image-audit-bia}
...
### Ballot Marking Device (BMD) {#ballot-marking-device-bmd}
...
### Ballot Style Masters (BSMs) {#ballot-style-masters-bsms}
...
### Ballot Summary Card {#ballot-summary-card}
...
### Ballots Cast (Number of) {#ballots-cast-number-of}
...
### Ballot Indexing File (BIF) {#ballot-indexing-file-bif}
...
### Cooperative Workflow {#cooperative-workflow}
...
### Contest or Ballot-Contest {#contest-or-ballot-contest}
...
### Contest Options {#contest-options}
...
### Contest Rendition {#contest-rendition}
...
### Contest Variant {#contest-variant}
...
### Direct Recording Electronic (DRE) voting machines {#direct-recording-electronic-dre-voting-machines}
...
### Disagreed Contest {#disagreed-contest}
...
### Dominion Voting Systems (Dominion) {#dominion-voting-systems-dominion}

A major voting system vendor with approximately 37% of the market.


### Duplicated / Remade / Rescanned Ballot {#duplicated-remade-rescanned-ballot}
...
### Election Information File (EIF) {#election-information-file-eif}
...
### Evaluation Heuristics {#evaluation-heuristics}
...
### Full Hand Count Audit (FHCA) {#full-hand-count-audit-fhca}
...
### Fully Agreed Sheets {#fully-agreed-sheets}
...
### Hand-Marked Paper Ballot {#hand-marked-paper-ballot}
...
### Hart Intercivic (Hart) {#hart-intercivic-hart}
...
### Hash Value / Hash Manifest File {#hash-value-hash-manifest-file}
...
### Job Settings File {#job-settings-file}
...
### JSON CVR Export {#json-cvr-export}
...
### List of Registered Voters {#list-of-registered-voters}
...
### List of Voters Who Voted {#list-of-voters-who-voted}
...
### Logic and Accuracy Test (LAT) {#logic-and-accuracy-test-lat}
...
### Partially Agreed Sheets {#partially-agreed-sheets}
...
### Poll Tapes / Digital Poll Tapes / Poll Tapes Audit {#poll-tapes-digital-poll-tapes-poll-tapes-audit}
...
### Protected Voters {#protected-voters}
...
### Public Oversight Workflow {#public-oversight-workflow}
...
### Repeated Ballot Images {#repeated-ballot-images}
...
### Risk-Limiting Audit (RLA) {#risk-limiting-audit-rla}
...
### TargetMapper App {#targetmapper-app}
...
### Unprocessed Sheets {#unprocessed-sheets}
...
### Verification Images, Verification Phase {#verification-images-verification-phase}
...
### Voter-Verifiable Paper Audit Trail (VVPAT) {#voter-verifiable-paper-audit-trail-vvpat}
...
### Voting System for All People (VSAP) {#voting-system-for-all-people-vsap}
