...
### Guides:
- [Exporting Guide](exporting_guide/) -- Guide for election staff to export ballot images and cast-vote records from ES&S or Dominion systems.
- [Uploading Guide](uploading_guide/) -- Guide for election staff or affiliates to upload ballot images and cast-vote records to AuditEngine.
